...
class About extends Component {
    ...
    componentDidMount(){
      getAboutUs()
      .then(res=>this.convertbase64(res.about_us[0].description))
    }
    convertbase64 = str => {
      ...
      converted = arr;
      this.setState({ about_us: converted, replacePattern1, replacePattern2, replacePattern3 });
    };
  render() {
    ...
    return (
      <View style={{ flex: 1 }}>
        <CustomHeader title="about Us" back {...this.props} />
        <View
          style={{
            position: "absolute",
            width: 80,
